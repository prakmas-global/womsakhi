...
import { useCreches } from "@/components/ux/entitlements";
import { FAMILY_HELP, WELLBEING_ART } from "@/components/ux/wellbeing/data";
  ...
  return (
    ...
    >
      <div className="mb-[18px] flex items-end justify-between gap-4">
        <div>
          <h1 className="text-[24px] font-bold" style={{ color: "var(--ux-ink)" }}>Family &amp; Childcare</h1>
              ...
              <Card key={c.id} className="ux-i ux-onscroll" style={{ ["--i" as string]: i }} pad={0}>
                <div className="flex">
                  ...
                  <div className="flex min-w-0 flex-1 flex-col p-[16px]">
                    ...
                    <p className="mt-2.5 text-[16px] font-bold" style={{ color: c.fee === "Free" ? "var(--ux-green-ink)" : "var(--ux-ink)" }}>
                      {c.fee}
                    </p>
                    {c.meals && (
                      <p className="mt-1.5 flex items-center gap-1.5 text-[12px]" style={{ color: "var(--ux-ink-2)" }}>
                    ...
                    <div className="mt-auto flex items-center justify-between gap-3 pt-3">
                      <p className="min-w-0 text-[11.5px] leading-snug" style={{ color: "var(--ux-faint)" }}>
            ...
            <Card key={f.id} className="ux-i ux-onscroll" style={{ ["--i" as string]: i }}>
              <div className="flex items-start gap-3.5">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="text-[14px] font-semibold leading-snug" style={{ color: "var(--ux-ink)" }}>{f.title}</h3>
                  <p className="mt-1.5 text-[12.5px] leading-relaxed" style={{ color: "var(--ux-muted)" }}>{f.body}</p>
                </div>
              </div>
            </Card>
          ))}
