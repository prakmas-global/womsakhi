...
function Rail({items}:{items:Item[]}){
  ...
  <section className={styles.promo}><Image src="/ux/saved/saved-promo-v1.png" alt={tr("saved.womanOrganisingIdeasSheWantsTo")} fill sizes="300px"/><div><h2>{tr("saved.saveWhat")}<br/>{tr("saved.inspiresYou")}</h2><p>{tr("saved.yourFutureSelf")}<br/>{tr("saved.willThankYou")}</p></div></section>
