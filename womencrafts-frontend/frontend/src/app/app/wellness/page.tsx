...
export default function WellnessDashboard() {
  return <HomeShell><div className={styles.page} data-dashboard="wellness">
    ...
    <section className={styles.secondaryGrid}>
      ...
      <article className={`${styles.card} ${styles.community}`}><header><div className={styles.communityTitle}><h2>Community support</h2><span className={styles.memberStack} aria-label="Women active in community"><Image src="/ux/art/avatar-woman-teal-shirt.webp" alt="" width={24} height={24} /><Image src="/ux/art/avatar-woman-hijab.webp" alt="" width={24} height={24} /><Image src="/ux/art/avatar-woman-purple-kurta.webp" alt="" width={24} height={24} /><Image src="/ux/art/avatar-woman-pink-glasses.webp" alt="" width={24} height={24} /></span></div><Link href="/app/circles">Join discussions <ArrowRight /></Link></header>
        <Link href="/app/circles" className={styles.discussion}><Image className={styles.avatar} src="/ux/art/avatar-woman-purple-kurta.webp" alt="Priya" width={34} height={34} /><span><b>Tips for healthy eating at work?</b><small>Posted in Nutrition</small></span><MessageCircle /><small>24</small></Link>
        <Link href="/app/circles" className={styles.discussion}><Image className={styles.avatar} src="/ux/art/avatar-woman-hijab.webp" alt="Aisha" width={34} height={34} /><span><b>How do you manage period pain?</b><small>Posted in Women&apos;s Health</small></span><MessageCircle /><small>18</small></Link>
        <Link href="/app/circles" className={styles.supportBanner}><span><b>You&apos;re not alone.</b><small>A community that cares.</small></span><Image src="/ux/wellness/community-women-v2.png" alt="Three women standing together in support" width={170} height={100} /><ArrowRight /></Link>
      </article>
    </section>
